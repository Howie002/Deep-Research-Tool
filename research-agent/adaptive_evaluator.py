...
_EVAL_SYSTEM = (
    ...
    " - **ENTITY MATCH (critical):** before crediting ANY support, confirm the evidence is "
    "about the SAME subject named in (a) — same person/org, not merely the same name. If a "
    "page is clearly about a DIFFERENT same-named entity (e.g. an athlete when the subject "
    "is a businessman, or an unrelated namesake), it provides NO support for any claim — "
    "return no updates for it. Disambiguate using the subject's known attributes.\n"
